<?php
/**
 * The loop that displays posts on the Author Page
 *
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php endif; ?>
			...
			<div class="entry-utility">
				<?php
					printf( __( '<span class="meta-prep meta-prep-author">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><span class="entry-date">%3$s</span></a>', 'thirtyten' ),
						get_permalink(),
						esc_attr( get_the_time() ),
						get_the_date(),
						get_author_posts_url( get_the_author_meta( 'ID' ) )
